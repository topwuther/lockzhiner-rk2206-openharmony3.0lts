...
/* Get element offset in archive */
mz_bool mz_zip_reader_file_ofs(mz_zip_archive *pZip, mz_zip_archive_file_stat *file_stat, mz_uint *ofs);

/* whether an archive element is compressed */
mz_bool mz_zip_reader_file_is_compressed(mz_zip_archive_file_stat *file_stat);
