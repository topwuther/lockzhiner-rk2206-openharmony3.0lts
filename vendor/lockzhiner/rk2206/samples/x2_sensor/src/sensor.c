...
void sensor_process()
{
    ...
    /* 引脚复用配置为GPIO */
    PinctrlSet(MQ_2_SENSOR, MUX_FUNC0, PULL_DOWN, DRIVE_LEVEL0);
    PinctrlSet(FLAME_SENSOR, MUX_FUNC0, PULL_DOWN, DRIVE_LEVEL0);
    PinctrlSet(LIGHT, MUX_FUNC0, PULL_DOWN, DRIVE_LEVEL0);
    PinctrlSet(ALERT_PIN, MUX_FUNC0, PULL_DOWN, DRIVE_LEVEL0);
    PinctrlSet(RAIN_SENSOR, MUX_FUNC0, PULL_DOWN, DRIVE_LEVEL0);
    PinctrlSet(WINDOW_PIN, MUX_FUNC0, PULL_DOWN, DRIVE_LEVEL0);
