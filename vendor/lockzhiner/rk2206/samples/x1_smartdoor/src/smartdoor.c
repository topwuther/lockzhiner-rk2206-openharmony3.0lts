...
void smartdoor_process()
{
    ...
    /* 引脚复用配置为GPIO */
    PinctrlSet(KEYPAD_SDO, MUX_FUNC0, PULL_KEEP, DRIVE_LEVEL0);
    PinctrlSet(KEYPAD_SCL, MUX_FUNC0, PULL_UP, DRIVE_LEVEL0);
    PinctrlSet(DOOR_PIN, MUX_FUNC0, PULL_KEEP, DRIVE_LEVEL0);

    PinctrlSet(TRACK_SENSOR, MUX_FUNC0, PULL_KEEP, DRIVE_LEVEL0);
    PinctrlSet(GARAGE_PIN, MUX_FUNC0, PULL_KEEP, DRIVE_LEVEL0);
