...
var time = 1000
var WantAgent;
describe('ActsAnsWantAgentFourProTest', function () {

    /*
     * @tc.number: ACTS_SetWant_0800
     * @tc.name: getWantAgent(OperationType.UNKNOWN_TYPE)
     * @tc.desc: verify the function of getWantAgent(OperationType.UNKNOWN_TYPE)
     */
