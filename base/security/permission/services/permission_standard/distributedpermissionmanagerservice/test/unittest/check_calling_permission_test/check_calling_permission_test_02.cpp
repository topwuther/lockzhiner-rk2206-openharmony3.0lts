...
HWTEST_F(CheckCallingPermissionTest2, CheckCallingPermission02, Function | MediumTest | Level1)
{
...
HWTEST_F(CheckCallingPermissionTest2, CheckCallingPermission03, Function | MediumTest | Level1)
{
    string permissionName = "ohos.permission.INTERNET";
    pid_t pid = getpid();
