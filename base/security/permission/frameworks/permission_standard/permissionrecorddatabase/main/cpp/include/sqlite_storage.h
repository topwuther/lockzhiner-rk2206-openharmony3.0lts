...
public:
    ...
    int FindByConditions(const DataType type, const GenericValues &andConditions, const GenericValues &orConditions,
...
private:
    ...
    std::string CreateSelectWithConditionPrepareSqlCmd(
